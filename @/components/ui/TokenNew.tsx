  ...
  return (
    <div className="w-[85%] mx-auto flex flex-col gap-3 mb-16 body-last">
      ...
      <div className="text-center">
        <p className="mb-2">Anyone can send $LAST to players.</p>
        <p className="mb-2">Approve amount to be sent.</p>
        <p className="mb-2">Send to player #.</p>
      </div>
      ...
      <div
        className="w-[100%] rounded-xl p-3 border border-zinc-400 dark:border-zinc-200 flex flex-col 
                ...
                "
      >
        <div className="m-1 capitalize text-center h2-last">Holdings</div>
            ...
            <div className="rounded-lg p-2 px-4 border border-zinc-500 dark:border-zinc-400 body-last">
              <div className="flex flex-col justify-center items-center my-2">
                ...
                <input
                  ...
                  id="approve"
                  required
                  className="w-[6rem] text-center text-4xl text-zinc-800 dark:text-zinc-200 border-[2px] border-slate-400 rounded-md my-2 px-1"
                  value={approveValue}
              ...
              <div className="flex md:flex-row flex-col justify-center items-center md:justify-between my-2">
                ...
                <div className="flex gap-1 items-center">
                  <input
                    type="text"
                    id="player_id"
                    className="w-[4rem] text-center text-4xl text-zinc-800 dark:text-zinc-200 border-[2px] border-slate-400 rounded-md my-2 px-1"
                    value={receiverId}
