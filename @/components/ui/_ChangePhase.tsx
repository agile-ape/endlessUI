  ...
  return (
    <Dialog>
      <DialogTrigger asChild>
        {/* Button to click on */}
        <Button variant="default" size="lg" className="w-full mt-4 text-xl">
          Change Phase
        </Button>
      </DialogTrigger>
        ...
        <div className="overflow-auto">
          <DialogHeader className="items-center">
            <DialogTitle className="text-3xl text-center font-normal">
              Change Day to Night, Night to Day, and more
            </DialogTitle>
            <ScrollArea className="h-[650px] md:h-[600px] rounded-md p-2">
              <DialogDescription className="w-[85%] mx-auto flex flex-col gap-3">
                ...
                <div className="w-[100%] text-xl leading-tight text-zinc-800 dark:text-zinc-200">
                  <p className="mb-2">
                    Any player can change the current phase once the countdown time has elapsed.
                  </p>
                ...
                <div className="w-[240px] mx-auto flex flex-col gap-4 justify-center items-center mb-4">
                  <Button variant="default" size="lg" className="w-[100%]">
